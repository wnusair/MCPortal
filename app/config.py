...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv("DATABASE_URL", f"sqlite:///{INSTANCE_DIR / 'mcportal.db'}")
    ...
    BACKUP_DIR = os.getenv("BACKUP_DIR", str(INSTANCE_DIR / "backups"))
    PENDING_UPLOAD_DIR = os.getenv("PENDING_UPLOAD_DIR", str(INSTANCE_DIR / "pending_uploads"))
